; (function ($, window, document, undefined) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append('<input type="password" name="password" class="form-control" "/>');
        this.element.append('<input type="text" name="password" class="form-control" style="display:none"/>');
